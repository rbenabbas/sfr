...
<form action="header.php?p=2" name="importer_form"  method="post" enctype="multipart/form-data">

<table  width="100%" style="min-height:100px;" > 
<tr>
           <td class="p1" colspan="2" > <b> Importer Une Demande</b>  </td>
  </tr>
<tr>
         <TD width="100" height="28" style="text-align:left " class='summary_data' > <b> La demande</b></TD>
...
include ('importer_dmd_files.php');
